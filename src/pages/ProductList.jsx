    ...
    <div>
      <Table celled>
        ...
        <Table.Body>
          ...
          <Table.Cell singleLine={true} ><Button color="green" onClick={()=>handleAddToCart(product)}
             icon='cart arrow down' label="Add to Cart" labelPosition="left"></Button></Table.Cell>
        </Table.Row>
           ))}
        </Table.Body>
